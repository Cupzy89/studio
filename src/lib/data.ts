...
export const paperRolls: PaperRoll[] = [
  { id: 'R001', name: 'Glossy Coated 120g', type: 'Coated', quantity: 75, reorderLevel: 50, lastUpdated: '2024-05-20T10:00:00Z' },
  { id: 'R002', name: 'Matte Coated 150g', type: 'Coated', quantity: 45, reorderLevel: 50, lastUpdated: '2024-05-21T11:30:00Z' },
  { id: 'R003', name: 'Standard Uncoated 80g', type: 'Uncoated', quantity: 120, reorderLevel: 100, lastUpdated: '2024-05-22T09:00:00Z' },
  { id: 'R004', name: 'Recycled Uncoated 100g', type: 'Uncoated', quantity: 30, reorderLevel: 75, lastUpdated: '2024-05-21T15:00:00Z' },
  { id: 'R005', name: 'Water-resistant Vinyl', type: 'Specialty', quantity: 60, reorderLevel: 40, lastUpdated: '2024-05-20T14:20:00Z' },
  { id: 'R006', name: 'Heavy Cardstock 300g', type: 'Specialty', quantity: 80, reorderLevel: 60, lastUpdated: '2024-05-22T16:00:00Z' },
];
